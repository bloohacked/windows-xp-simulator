...
$(window).on('xpboot', function() {
  xp.applications.add('browser', (args) => {
      ...
      var el = $.parseHTML(`<window title="Idiot Exploder" width="800" height="500">
        <style>
    .load-overlay {
      position: absolute;
      top: 24;
  ...
  xp.startmenu.add('browser', 'Idiot Exploder 6', 'https://www.freeiconspng.com/uploads/internet-explorer-logo-icon-10.png');
});
